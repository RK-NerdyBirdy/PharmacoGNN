...
from app.schemas.explain import ExplainInteractionRequest, ExplainInteractionResponse
...
async def explain_interaction(
    ...
    context = {
        ...
        # No drug-protein/protein-protein edge data is available yet (same gap as
        # gnn_engine's Z_DRUG_CACHE_DEGRADED) -- always empty, never fabricated.
        "pathway": {"nodes": [], "edges": []},
    }
